...
PLIK_PROGNOZY = KATALOG_DANYCH / "wyniki_modelu" / "prognoza_udzialu_ev_2026_2040.csv"
PLIK_HISTORII = KATALOG_DANYCH / "wyniki_modelu" / "wyniki_modelu_ev_historyczne.csv"
PLIK_WYKRESU = KATALOG_DANYCH / "wykresy" / "wykres_prognozy_udzialu_ev_2026_2040.png"


def main() -> None:
    KATALOG_DANYCH.joinpath("wykresy").mkdir(parents=True, exist_ok=True)
