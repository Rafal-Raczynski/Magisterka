...
KATALOG_SCENARIUSZY = KATALOG_DANYCH / "scenariusze"
PLIK_PKB = KATALOG_SCENARIUSZY / "prognoza_pkb_polska_2026_2040.csv"
PLIK_RELACJI = KATALOG_SCENARIUSZY / "prognoza_relacji_kosztu_polska_2026_2040.csv"
PLIK_SCENARIUSZA = KATALOG_SCENARIUSZY / "scenariusz_ev_2026_2040.csv"
...
def main() -> None:
    ...
    KATALOG_SCENARIUSZY.mkdir(parents=True, exist_ok=True)
