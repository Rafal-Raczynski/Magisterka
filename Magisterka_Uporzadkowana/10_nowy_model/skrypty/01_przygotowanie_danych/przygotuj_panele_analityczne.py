...
KATALOG_TABEL = KATALOG_DANYCH / "tabele_panelowe"
KATALOG_PANELI = KATALOG_DANYCH / "panele_analityczne"
PLIK_SAMOCHODY = KATALOG_TABEL / "tabela_samochody_panel.csv"
PLIK_PKB = KATALOG_TABEL / "tabela_pkb_panel.csv"
PLIK_CENY = KATALOG_TABEL / "tabela_ceny_energii_i_paliw_panel.csv"
PLIK_LADOWARKI = KATALOG_TABEL / "tabela_ladowarki_panel.csv"
PLIK_PODSTAWOWY = KATALOG_PANELI / "panel_analityczny_podstawowy.csv"
PLIK_ROZSZERZONY = KATALOG_PANELI / "panel_analityczny_rozszerzony.csv"
...
def main() -> None:
    ...
    KATALOG_PANELI.mkdir(parents=True, exist_ok=True)
