...
ESTYMACYJNE_ROOT = DATA_ROOT / "Estymacyjne_dane"
...
def generuj_finalna_prognoze_magisterska():
    ...
    df_aic = pd.read_csv(ESTYMACYJNE_ROOT / "prognoza_aic_per_capita_polska.csv")
    x2 = df_aic[df_aic['Rok'] >= 2025]['Prognozowany AIC per capita (PPS)'].values
    
    df_x3 = pd.read_csv(ESTYMACYJNE_ROOT / "prognoza_x3_koszt_100km.csv")
    ...
    df_x5 = pd.read_csv(ESTYMACYJNE_ROOT / "prognoza_infrastruktura_x5.csv")
