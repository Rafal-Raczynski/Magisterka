...
def estymacja_os():
    data = pd.read_csv(UPORZADKOWANE_ROOT / "TRAN_1733_CREL_20260125154356.csv", sep=';')
    print(data.head())
    ...
    df_prognoza.to_csv(ESTYMACYJNE_ROOT / "prognoza_liczba_samochodow_osobowych_polska_sigmoid.csv", index=False)
